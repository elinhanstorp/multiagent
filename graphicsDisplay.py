...
class InfoPane:
    ...
    def drawPane(self):
        self.scoreText = text( self.toScreen(0, 0  ), self.textColor, "SCORE: 0   TIME: 0", "Times", self.fontSize, "bold")
    ...
    def updateScore(self, score, tiempo):
        changeText(self.scoreText, "SCORE: %4d   TIME: %4d" % (score,tiempo))
...
class PacmanGraphics:
    ...
    def update(self, newState):
        ...
        self.infoPane.updateScore(newState.score, newState.tiempo)
